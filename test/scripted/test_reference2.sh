...
<task>
    <parameters>
        ...
        <lattice name="hyperhoneycomb" range="3"/>
        <model name="hyperhoneycomb-kitaev" symmetry="${CORE}">
            <j>0.1</j>
            <k>-1.0</k>
        </model>
    </parameters>
...
${TEST_EVAL} FILE ${TEST_WORK_DIR}/${TEST_NAME}.XYZ.obs ${TEST_REF_DIR}/${TEST_NAME}.ref
${TEST_EVAL} OBJECT ${TEST_WORK_DIR}/${TEST_NAME}.XYZ.obs XYZCorDD ${TEST_WORK_DIR}/${TEST_NAME}.TRI.obs TRICorDD
${TEST_EVAL} OBJECT ${TEST_WORK_DIR}/${TEST_NAME}.XYZ.obs XYZCorXX ${TEST_WORK_DIR}/${TEST_NAME}.TRI.obs TRICorXX
${TEST_EVAL} OBJECT ${TEST_WORK_DIR}/${TEST_NAME}.XYZ.obs XYZCorYY ${TEST_WORK_DIR}/${TEST_NAME}.TRI.obs TRICorYY
${TEST_EVAL} OBJECT ${TEST_WORK_DIR}/${TEST_NAME}.XYZ.obs XYZCorZZ ${TEST_WORK_DIR}/${TEST_NAME}.TRI.obs TRICorZZ
