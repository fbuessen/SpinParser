#define BOOST_TEST_MODULE "XYZVertexSingleParticleTest"
#include <boost/test/included/unit_test.hpp>
#include "LatticeModelFactory.hpp"
#include "XYZ/XYZVertexSingleParticle.hpp"
...
struct XYZVertexSingleParticleFixture
{
	XYZVertexSingleParticleFixture()
	{
	...
	XYZVertexSingleParticle *v;
	SpinParser *spinParser;
};

BOOST_FIXTURE_TEST_SUITE(XYZVertexSingleParticleTest, XYZVertexSingleParticleFixture);
