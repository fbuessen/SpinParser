#define BOOST_TEST_MODULE "TRIVertexSingleParticleTest"
#include <boost/test/included/unit_test.hpp>
#include "LatticeModelFactory.hpp"
#include "TRI/TRIVertexSingleParticle.hpp"
...
struct TRIVertexSingleParticleFixture
{
	TRIVertexSingleParticleFixture()
	{
	...
	TRIVertexSingleParticle *v;
	SpinParser *spinParser;
};

BOOST_FIXTURE_TEST_SUITE(TRIVertexSingleParticleTest, TRIVertexSingleParticleFixture);
