/**
 * @file XYZVertexSingleParticle.hpp
 * @author Finn Lasse Buessen
 * @brief Single-particle vertex implementation for models with diagonal interactions.
 * 
 ...
 * @brief Single-particle vertex implementation for models with diagonal interactions.
 */
struct XYZVertexSingleParticle
{
public:
	/**
	 * @brief Construct a new XYZVertexSingleParticle object and initialize all values to zero. 
	 */
	...
	/**
	 * @brief Destroy the XYZVertexSingleParticle object. 
	 */
	~XYZVertexSingleParticle()
	{
		delete[] _data;
	...
	/**
	 * @brief Directly access a vertex value by reference via a linear iterator in the range [0,XYZVertexSingleParticle::size). 
	 * 
