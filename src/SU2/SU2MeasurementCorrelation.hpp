...
public:
	/**
	 * @brief Construct a new SU2MeasurementCorrelation object to measure correlations. 
	 * @see Measurement
	 * 
	...
	/**
	 * @brief Destroy the SU2MeasurementCorrelation object. 
	 */
...
private: 
	...
	float *_correlationsZZ; ///< Buffer for spin correlation measurements. 
